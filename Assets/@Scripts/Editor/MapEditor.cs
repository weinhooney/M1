...
public class MapEditor : MonoBehaviour
{
    ...
    private static void GenerateMap()
    {
        ...
        foreach(GameObject go in gameObjects)
        {
            ...
            using (var writer = File.CreateText($"Assets/@Resources/Datas/MapData/{go.name}Collision.txt"))
            {
    ...
    {
        TextAsset textAsset = UnityEditor.AssetDatabase.LoadAssetAtPath<TextAsset>($"Assets/@Resources/Datas/JsonData/{path}.json");
